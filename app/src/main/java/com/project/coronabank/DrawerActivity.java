package com.project.coronabank;
...
import com.project.coronabank.Model.Account;
import com.project.coronabank.Model.Profile;
import com.project.coronabank.Model.db.ApplicationDB;
...
public class DrawerActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void makeDeposit() {
        ...
        if (depositAmount < 0.01 && !isNum) {
            ...
            Toast.makeText(this, "Deposit of ZAR" + String.format(Locale.getDefault(), "%.2f", depositAmount) + " " + "made successfully", Toast.LENGTH_SHORT).show();
    ...
    public void displayHelpDialog() {
        ...
        builder.setTitle("Help")
                .setMessage("This CoronaBank was made by Melvin Kisten. Soon, this dialog will give the user help, depending on where they are in the app");
