    ...
    private void confirmTransfer() {
        ...
        if (isNum) {
            if (spnSendingAccount.getSelectedItemPosition() == receivingAccIndex) {
                ...
                Toast.makeText(getActivity(), "The minimum amount for a transfer is ZAR0.01", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(getActivity(), "Transfer of ZAR" + String.format(Locale.getDefault(), "%.2f", transferAmount) + " successfully made", Toast.LENGTH_SHORT).show();
            }
        }
    }
